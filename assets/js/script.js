...
chrome.storage.sync.get(function (obj) {
    ...
    if((window.location.host === 'my.api.net.au' || window.location.host === 'sigmaws.signet.com.au') && active === true) {
        loadScript();
    }else{
        licenseProblem();
    }
            ...
            chrome.runtime.sendMessage({
                ...
                if (response) {
                    ...
                    product.element.find(".product-name a").after(
                        ...
                        "<br/><span class='badge badge-info small pointer' data-toggle='modal' data-target='#" + response.result.data[0].StockID + "'>StockCards Info</span>"
                    );
